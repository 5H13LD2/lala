...
class SqlModuleAdapter(
    ...
    inner class ModuleViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(module: Module) {
            ...
            Log.d("SqlModule", "Module Progress: $progressPercentage%")
            ...
            val lessonAdapter = LessonAdapter(context, module.lessons, completedLessonIds,
                ...
                onLessonCompleted = { lessonId ->
                    ...
                    Log.d("SqlModule", "Completed Lessons: $completedLessonIds")
                }
            )
            ...
            btnTakeQuizzes.setOnClickListener {
                Log.d("SqlModuleAdapter", "Quiz button clicked for module: ${module.id} - ${module.title}")
                onQuizClick(module)
            }
